function save_config_csv()
    ...
    scenarios_config_props = {'lead_senario', 'Use_predict_observer', 'predict_controller_type', ...
                             ...
                             'Use_smooth_filter', 'Use_smooth_filter_in_local_observer', ...
                             'measurement_noise_variance', 'process_noise_variance', ...
                             'no_noise_measurement_variance', 'no_noise_process_variance', ...
                             'measurement_noise_correlation', 'noise_filter_alpha', ...
                             'local_observer_output_filter_alpha', ...
