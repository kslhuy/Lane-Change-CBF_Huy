...
attack_type = "Bogus"; % "bias" , "faulty" , "scaling" , "Collusion" ,"Bogus"
...
car2.assign_neighbor_vehicle(platton_vehicles, [],"CIDM", center_communication,  graph);
car3.assign_neighbor_vehicle(platton_vehicles, [],"CIDM", center_communication, graph );
car4.assign_neighbor_vehicle(platton_vehicles, [],"CIDM", center_communication, graph);
