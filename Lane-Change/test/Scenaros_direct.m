...
car2.controller.logic_ctrl.other_vehicles = [car1; car3; car4;car5];

% % disp(car2.controller)
% disp(length(car2.controller.controller.other_vehicles))

car3.controller.logic_ctrl.other_vehicles = [car1,car2];
car4.controller.logic_ctrl.other_vehicles = [car1,car2,car3];
car5.controller.logic_ctrl.other_vehicles = [car1,car2,car3,car4];
