...
%%%%%%%%%
%%%%%%%%%
%% Here plot mean for different attacker vehicle in platoon. 
clc
close all
clear
...
for case_nb_attack = 2:total_num_attack_cases
...
for i = 1:3  % Metrics
    ...
    title(['Mean ', metric_labels{i}, ' per Bogus Attack Scenario']);
    grid on;
end