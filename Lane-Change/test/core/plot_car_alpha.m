function[] = plot_car_alpha(state, L, H, color, alpha)
theta = state(3);
center1 = state(1);
center2 = state(2);
...
patch('Vertices', [x_coor; y_coor]', 'Faces', [1, 2, 3, 4], 'Edgecolor', color, 'Facecolor', color, 'Linewidth', 1.2, 'FaceAlpha', alpha, 'EdgeAlpha', alpha);
axis equal;
end