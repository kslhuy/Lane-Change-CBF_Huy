function attack_module =  Atk_Scenarios(attack_module , attack_type , case_num , t_star,t_end , target_vehicle_id)
    ...
    % Effect: Vehicles react to incorrect velocity or position values.
        ...
        switch case_num
            case 1
                ...
                scenario1_Case1 = struct('target_vehicle_id', target_vehicle_id, ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'scaling', ...
            ...
            case 2
                ...
                scenario1_Case2 = struct('target_vehicle_id', target_vehicle_id, ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'scaling', ...
            ...
            case 3
                ...
                scenario1_Case3 = struct('target_vehicle_id', target_vehicle_id, ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'bias', ...
            ...
            case 4
                ...
                scenario1_Case4 = struct('target_vehicle_id', target_vehicle_id, ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'bias', ...
    ...
    % Effect: Vehicles keep outdated speed values, causing instability.
        ...
        switch case_num
            case 1
                ...
                scenario2_Case1 = struct('target_vehicle_id', target_vehicle_id, ...
                                        'start_time', 30, ...
                                        'end_time', 50, ...
                                        'attack_type', 'bias', ...
            ...
            case 2
                ...
                scenario2_Case2 = struct('target_vehicle_id', target_vehicle_id, ...
                                        'start_time', 30, ...
                                        'end_time', 50, ...
                                        'attack_type', 'bias', ...
    ...
    % Effect: Severe platoon instability due to multiple compromised vehicles.
        switch case_num
            case 1
                ...
                scenario3_Case1 = struct('target_vehicle_id', [3,4], ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'scaling', ...
                                        'fault_intensity', -0.5, ...
            ...
            case 2
                ...
                scenario3_Case2 = struct('target_vehicle_id', [3,4], ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'scaling', ...
                                        'fault_intensity', 0.5, ...
            ...
            case 3
                ...
                scenario3_Case3 = struct('target_vehicle_id', [3,4], ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'bias', ...
                                        'fault_intensity', -15, ...
            ...
            case 4
                ...
                scenario3_Case4 = struct('target_vehicle_id', [4, 5, 6], ...
                                        'start_time', t_star, ...
                                        'end_time', t_end, ...
                                        'attack_type', 'bias', ...
                                        'fault_intensity', 33, ...
